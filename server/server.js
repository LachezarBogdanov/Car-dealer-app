(function (global, factory) {
    ...
    var seedData = {
        ...
        cars: {
            ...
            "color": "Син",
            "city": "Каспичан",
            "description": "Нов внос от Германия! Един предишен собственик, който е вписан в талона. Всичко работи безупречно по автомобила! ПЕРФЕКТЕН! Високо ниво на оборудване! Панорамен таван, автопилот, навигация, ел. пакет, адаптивни фарове, полу кожен салон, Hands free и много други екстри!!! Два комплекта гуми с джанти! Без пребоядисани детайли абсолютно! Салона и интериора са изключително запазени! Възможност за тест драйв с фирмени номера! Съдействие при регистрация и транзитни номера!",
            "images": [
        ...
        features: 'Комфорт: Климатроник, Кожен салон, Ел. стъкла, Ел. огледала, Подгряване на седалки, Шибедах, Стерео уредба, Алуминиеви джанти, Мултифункционален волан',
        phone: '0886775596',
